...
public class ObjectFactory {
    ...
    private final static QName _Minus_QNAME = new QName("http://calculator/", "minus");
    ...
    private final static QName _MinusResponse_QNAME = new QName("http://calculator/", "minusResponse");
    private final static QName _Divide_QNAME = new QName("http://calculator/", "divide");
    private final static QName _PlusResponse_QNAME = new QName("http://calculator/", "plusResponse");
    private final static QName _Plus_QNAME = new QName("http://calculator/", "plus");
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://calculator/", name = "minus")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://calculator/", name = "minusResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://calculator/", name = "plusResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://calculator/", name = "plus")
