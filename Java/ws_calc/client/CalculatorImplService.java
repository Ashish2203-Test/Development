 ...
 * 
 */
@WebServiceClient(name = "CalculatorImplService", targetNamespace = "http://calculator/", wsdlLocation = "http://localhost:8890/rs?wsdl")
    ...
    extends Service
{
    ...
    static {
        ...
        try {
            url = new URL("http://localhost:8890/rs?wsdl");
