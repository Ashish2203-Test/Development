 ...
 * 
 */
@WebServiceClient(name = "CalculatorImplService", targetNamespace = "http://calculator/", wsdlLocation = "file:/Users/admin/Desktop/Development/Java/ws_calc_v2/calc.wsdl")
    ...
    extends Service
{
    ...
    static {
        ...
        try {
            url = new URL("file:/Users/admin/Desktop/Development/Java/ws_calc_v2/calc.wsdl");
    ...
    public Operations getCalculatorImplPort() {
        return super.getPort(new QName("http://calculator/", "CalculatorImplPort"), Operations.class);
    }
     ...
     */
    @WebEndpoint(name = "CalculatorImplPort")
    public Operations getCalculatorImplPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://calculator/", "CalculatorImplPort"), Operations.class, features);
    }
